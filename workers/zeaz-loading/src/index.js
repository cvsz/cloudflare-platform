  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      color: var(--text);
      background:
        radial-gradient(circle at 18% 20%, rgba(124,58,237,.34), transparent 32%),
        radial-gradient(circle at 82% 18%, rgba(6,182,212,.28), transparent 30%),
        radial-gradient(circle at 50% 90%, rgba(34,197,94,.16), transparent 34%),
        linear-gradient(135deg, var(--bg1), var(--bg2) 62%, #020617);
      overflow: hidden;
    }
    ...
    .mark {
      ...
      box-shadow:
        0 18px 52px rgba(6,182,212,.22),
        0 16px 45px rgba(124,58,237,.28);
    }
    ...
    .gradient {
      background: linear-gradient(90deg, #fff, #c4b5fd 38%, #67e8f9 72%, #bbf7d0);
    ...
    .bar {
      ...
      box-shadow: 0 0 28px rgba(6,182,212,.55);
      animation: load 2.25s ease-in-out infinite;
    }
...
<body>
  <main aria-busy="true" aria-live="polite">
    ...
    <section class="card" role="status" aria-label="${brandName} loading">
      ...
      <h1>
        <span class="gradient">${brandName}</span><br />
        กำลังโหลดระบบ<br />
        <span style="font-size:.58em;letter-spacing:-.03em;color:#cbd5e1;">System Loading</span>
      </h1>

      <p class="subtitle">
        <strong>ไทย:</strong>
        กำลังเตรียมระบบ AI Automation, Cloudflare Edge Routing,
        Zero Trust Access และ Workspace Security สำหรับเซสชันของคุณ
        <br /><br />
        <strong>English:</strong>
        Preparing AI automation, Cloudflare Edge routing,
        Zero Trust access, and secure workspace services for your session.
      </p>
      ...
      <div class="chips" aria-hidden="true">
        <span class="chip">Cloudflare Edge</span>
        <span class="chip">Zero Trust</span>
        <span class="chip">AI Control Plane</span>
        <span class="chip">Secure Workspace</span>
      </div>

      <div class="actions">
        <a class="button" href="${appUrl}">
          เปิดหน้าแดชบอร์ด / Open Dashboard
        </a>
      </div>
    </section>
  </main>
